...
public class MobileDaoJdbcImpl implements MobileDao {
  ...
  public static final String INSERT_INTO_MOBILE = "INSERT INTO mobile.mobile values (DEFAULT, ?, ?, ?)";
  public static final String SELECT_FROM_MOBILE = "SELECT * FROM mobile.mobile WHERE id = ?";
  public static final String SELECT_ALL_FROM_MOBILE = "SELECT * FROM mobile.mobile";
  public static final String UPDATE_MOBILE = "UPDATE mobile.mobile SET model=?, price=?, manufacturer=? WHERE id=?";
  public static final String DELETE_FROM_MOBILE = "DELETE FROM mobile.mobile WHERE id=?";
